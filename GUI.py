...
class BootloaderApp(ttk.Window):
            ...
            try:
                ...
                while '\n' in buffer:
                    ...
                    if line == "OK":
                        ...
                        print("Received WRONG - flashing failed")
                        app_status = 0  # Set status to Not OK
                        self.sending = False
                        self.pending_fwfile = None
    ...
    def abort_flash(self):
        ...
        self.pending_fwfile = None
        messagebox.showwarning("Abort", "Transfer aborted close GUI and relaunch.")
...
if __name__ == "__main__":
    ...
    #in my booltloader project i am storing the bootloader from 0x00000000 and the application code i am storing form 0x00008000 so give me the function for the jumptoapp that will jumps to a
    # think about this condition that we didnt change the linker file settings and we flashed that code in application area in flash so take this case and give proper condition that if the linker file is correct then it has to jump to app or it want to stay in booltloader
    #reset handler address is 0x00000411 this is linker file setting are not chnaged address and correct linker file settings chnaged reset handler address is 0x00008411 so accordingly give me condtion 